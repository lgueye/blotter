...
ALTER TABLE normalized_orders
    ADD CONSTRAINT idx_normalized_orders_uniq UNIQUE (portfolio, instrument, meta_type, intent, settlement_date);
...
CREATE INDEX idx_normalized_orders_setlmt_date
    ON normalized_orders (settlement_date);

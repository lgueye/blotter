Feature: stex search
  ...
  Scenario: Should properly find stex messages
    ...
    Given blotter system receives stex orders from AVQ
      ...
      | stex-ingestion-external-identifier-400 | mathieu | PF-000000002 | 600000 | LU17000000 | sell   |

    And blotter system receives fx orders from AVQ
      | externalIdentifier                     | author  | portfolio    | amount | instrument | intent |
      | stex-ingestion-external-identifier-300 | mathieu | PF-000000001 | 800000 | LU19000000 | sell   |

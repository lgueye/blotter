...
public class BlotterNotificationProducerConfiguration {
	...
	@Bean
	public ProducerFactory<String, OrderNotificationDto> producerFactory() {
	...
	@Bean
	public KafkaTemplate<String, OrderNotificationDto> kafkaTemplate(final ProducerFactory<String, OrderNotificationDto> producerFactory) {
